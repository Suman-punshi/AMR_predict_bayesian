...
def plot_comparative_histograms(avg_file, eval_log_files, model_names, specie, dataset, output_dir="figures"):
    ...
    - set_name (str): Dataset/set name for labeling and filenames.
    ...
    for label in labels:
        ...
        # Save (include set name in filename)
...
def plot_uncertainty_distributions(log_file, specie, dataset, output_dir="uncertainty_plots"):
    ...
    - dataset (str): Dataset/set name for labeling and filenames.
    - output_dir (str): Directory where plots will be saved.
    """
    import os, json
    import numpy as np
    ...
    for entry in metrics:
        ...
        # Format x-axis to two decimal places
        ax.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))

        # Save with set name in filename
        fname = os.path.join(output_dir, f"{specie}_{dataset}_{label.replace(' ', '_')}_uncertainty.png")
        plt.savefig(fname, dpi=300, bbox_inches="tight")
        plt.close()
        print(f"Saved {fname}")
...
plot_comparative_histograms(avg_file, eval_log_files, ["Last two Layer Bayesian", "Deterministic", "Last Layer Bayesian"], specie="E. coli", dataset="Set A", output_dir="Results/SetA_results/figures")
...
plot_comparative_histograms(avg_file, eval_log_files, ["Last two Layer Bayesian", "Deterministic", "Last Layer Bayesian"], specie="K. pneumoniae", dataset="Set A", output_dir="Results/SetA_results/figures")
...
plot_comparative_histograms(avg_file, eval_log_files, ["Last two Layer Bayesian", "Deterministic", "Last Layer Bayesian"], specie="S. aureus", dataset="Set A", output_dir="Results/SetA_results/figures")
